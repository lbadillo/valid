package com.valid.example.repository;

import com.valid.example.ValidApp;
import com.valid.example.config.Constants;
import com.valid.example.config.audit.AuditEventConverter;
import com.valid.example.domain.PersistentAuditEvent;
...
import static com.valid.example.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
